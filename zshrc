...
# ============================================================
if [[ -r "${XDG_CACHE_HOME:-$HOME/.dev/cache}/p10k-instant-prompt-${(%):-%n}.zsh" ]]; then
  source "${XDG_CACHE_HOME:-$HOME/.dev/cache}/p10k-instant-prompt-${(%):-%n}.zsh"
fi
...
# LS_COLORS
# ============================================================
LS_COLORS_FILE="$XDG_CONFIG_HOME/ls_colors"
